...
conda install -c bioconda -c conda-forge bioconductor-qvalue bioconductor-edger bioconductor-deseq2 r-fastcluster openblas starseqr samtools gffread star subread openssl=1.0 -y
