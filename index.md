...
> ## Class Information
> **Course Number:** BCH 709-1001 (22030)
> **Credits:** 3
...
**Instructor:** Dr. Won C. Yim
**Office:** Howard Medical Sciences 216
**Tel:** 775-784-9447
**Email:** wyim@unr.edu
**Office hours:** 10:30 – noon, Thursday or by appointment.
...
> - UNR affiliated email **\<ID\>@unr.edu or \<ID\>@nevada.unr.edu** - [How to Activate](https://oit.unr.edu/services-and-support/login-ids-and-passwords/netid/netid-activation/)
...
> - Please fill this [form](https://forms.gle/nAH3wkjnfkNhrWM47)
{: .callout}
...
| Week10 | 3/31/2026 | Tuesday  | Gene family analysis and phylogenetics (David Alvarez-Ponce, PhD)  |
...
| Week13 | 4/23/2026 | Thursday | [HPC — ChIP-Seq pipeline](chipseq_hpc/index.html)                  |
...
### Research Computing Hackathon ([Hosted by HPC team](https://www.unr.edu/research-computing/hpc))
...
- [Introduction to Bioinformatics (3rd Edition)](http://app.knovel.com/web/toc.v/cid:kpIBE00007/viewerType:toc/)
- [Learn Linux Shell Scripting - Fundamentals of Bash 4.4](https://www.oreilly.com/library/view/learn-linux-shell/9781788995597/)
- [Effective awk Programming, 3rd Edition](https://www.oreilly.com/library/view/effective-awk-programming/0596000707/)
- [Bioinformatics with Python Cookbook - Second Edition](https://www.oreilly.com/library/view/bioinformatics-with-python/9781789344691/)
- [Basic Applied Bioinformatics](https://www.oreilly.com/library/view/basic-applied-bioinformatics/9781119244332/)
- [Ubuntu Linux Unleashed 2021 Edition, 14th Edition](https://www.oreilly.com/library/view/ubuntu-linux-unleashed/9780136685395/)
- [Unix and Perl Primer for Biologists (Keith Bradnam & Ian Korf)](https://github.com/KorfLab/unix_and_perl/blob/main/UnP4B-3.1.2.pdf)
- [Other bioinformatics books from knovel](http://app.knovel.com/web/search.v?q=bioinformatics&search_type=tech-reference&rows=10&offset=0&group_by=true&my_subscription=true&sort_on=default&content_type=all_references&include_synonyms=no)
- [Other bioinformatics books from O'Reilly](https://www.oreilly.com/search/?q=bioinformatics)
...
> ## Teaching Platform
> This lecture was designed to be run on [Unix-base system](https://en.wikipedia.org/wiki/Unix) such as Ubuntu, mac, etc. All the software and data used in the class will be open source. All example data will be hosted on a Google Cloud Service. If you want to know how to use Unix-base system on your computer, please follow the directions in the [Setup](setup.html) tab.
{: .prereq}
